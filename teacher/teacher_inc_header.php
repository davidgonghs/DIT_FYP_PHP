...
$program->setDean($staff_number);
$teacher_program_number = $db->count($program::$db_name,$program);
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="teacher_index.php" class="nav-link">Home</a>
            </li>
        </ul>
        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item">
                <a class="nav-link" data-widget="fullscreen" href="teacher_index.php" role="button">
...
<li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                           <li class="nav-item">
                                <a href="teacher_programOutcomeLIst.php" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Program Outcome</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="teacher_teacherUserLIst.php" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Program Teachers</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="teacher_studentUserList.php" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Program Students</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="teacher_semesterList.php" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Program Semester</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="teacher_subjectList.php" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
...
A;
    echo $html;
                    ...
                    <li class="nav-item">
                        <a href="teacher_recover_password.php" class="nav-link">
